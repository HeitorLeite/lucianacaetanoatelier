...
import img7 from "../assets/img/necessarie_7.png";
import img8 from "../assets/img/necessarie_mar.png";

const Colecao = () => {
  const produtos = [img1, img2, img3, img4, img5, img6, img7, img8];

  return (
    <section className="w-full py-20 px-4 bg-white text-black text-center">
